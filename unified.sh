...
git clone git://github.com/VRanger/dragontc dragontc
...
export DEFCONFIG="onclite-perf_defconfig";
...
make -j$(nproc --all) O=out \ 
  ...
  ${MAKE} -j${JOBS} \ ARCH=arm64 \ CROSS_COMPILE="$HOME/TC/aarch64-linux-gnu-8.x/bin/aarch64-linux-gnu-";
